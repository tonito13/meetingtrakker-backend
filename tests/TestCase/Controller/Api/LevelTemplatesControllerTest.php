...
use App\Controller\Api\LevelTemplatesController;
use Cake\TestSuite\IntegrationTestTrait;
use Cake\TestSuite\TestCase;

/**
 * App\Controller\Api\LevelTemplatesController Test Case
 */
class LevelTemplatesControllerTest extends TestCase
{
    use IntegrationTestTrait;

    protected array $fixtures = ['app.LevelTemplate', 'app.Users'];

    private const VALID_USERNAME = 'test';
    private const VALID_PASSWORD = '12345';
    private const VALID_TEMPLATE_NAME = 'Test Level Template';
    ...
    public function testAddLevelTemplateWithValidData(): void
    {
        ...
        $consoleOutput = $this->captureConsoleOutput(function () use ($token): void {
            ...
            $this->post('/api/level-templates/addLevelTemplate.json', [
    ...
    public function testUpdateLevelTemplateWithValidData(): void
    {
        ...
        $consoleOutput = $this->captureConsoleOutput(function () use ($token, $templateId): void {
            ...
            $this->post('/api/level-templates/updateLevelTemplate.json', [
                'id' => $templateId,
    ...
    public function testGetLevelTemplateWithValidAuthentication(): void
    {
        ...
        $consoleOutput = $this->captureConsoleOutput(function () use ($token): void {
            ...
            $this->get('/api/level-templates/getRoleLevelForm.json');
        });
    ...
    public function testAddLevelTemplateWithUnicodeAndSpecialCharacters(): void
    {
        ...
        $consoleOutput = $this->captureConsoleOutput(function () use ($token, $unicodeData): void {
            ...
            $this->post('/api/level-templates/addLevelTemplate.json', $unicodeData);
        });
    ...
    public function testAddLevelTemplateWithWrongHttpMethods(): void
    {
        ...
        foreach ($wrongMethods as $method) {
            $consoleOutput = $this->captureConsoleOutput(function () use ($method): void {
                ...
                switch ($method) {
                    case 'GET':
                        $this->get('/api/level-templates/addLevelTemplate.json');
                        break;
                    case 'PUT':
                        $this->put('/api/level-templates/addLevelTemplate.json');
                        break;
                    case 'DELETE':
                        $this->delete('/api/level-templates/addLevelTemplate.json');
                        break;
                    case 'PATCH':
                        $this->patch('/api/level-templates/addLevelTemplate.json');
                        break;
                }
            });
    ...
    public function testTemplateBackupAndRestoreScenarios(): void
    {
        ...
        $consoleOutput2 = $this->captureConsoleOutput(function () use ($token, $templateId): void {
            ...
            $this->get("/api/level-templates/getLevelTemplate.json?id=$templateId");
        });
