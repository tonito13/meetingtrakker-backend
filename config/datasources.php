...
$dataSources['test'] = setupDataSource('scorecardtrakker_postgres_database', 'scorecardtrakker_user', 'securepassword', 'scorecardtrakker_test');
$dataSources['client_200001'] = setupDataSource('scorecardtrakker_postgres_database', 'scorecardtrakker_user', 'securepassword', '200001');
$dataSources['client_200001_test'] = setupDataSource('scorecardtrakker_postgres_database', 'scorecardtrakker_user', 'securepassword', '200001_test');
$dataSources['test_client_200001'] = setupDataSource('scorecardtrakker_postgres_database', 'scorecardtrakker_user', 'securepassword', 'client_200001_test');
